...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[注册相关错误码](#4.1.1.1 用户注册)
...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[登录相关错误码](#4.1.1.2 用户登录)
...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[用户登出相关错误码](#4.1.1.3 用户登出)
...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[用户信息相关错误码](#4.1.1.4 用户信息)
...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[修改密码相关错误码](#4.1.1.5 修改密码)
...
- 补充说明：
  ...
  > 其他可能的错误码请参考：[邮箱相关错误码](#4.1.2 邮箱接口)
...
| 错误码 | 描述                                 | 解决方案               |
| ------ | ------------------------------------ | ---------------------- |
| 401    | 认证失败，用于身份验证以及验证码验证 | 检查填写的信息是否有效 |
